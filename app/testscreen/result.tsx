...
const ResultScreen = () => {
  ...
  try {
    parsedRawData = JSON.parse(decodeURIComponent(rawDataString));
  } catch (error) {
    console.error('❌ Lỗi khi parse rawData:', error);
  }
...
const styles = StyleSheet.create({
  ...
  summaryContainer: { marginBottom: 5, textAlign: 'center', alignItems: 'center', paddingHorizontal: 10 },
